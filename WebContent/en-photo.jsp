...
<body>
  	...
  	<div id="element" class="element">
  		...
  		<div class="important">请上传图片文件（图片长宽比为1，如:100*100），点击框外取消该操作</div>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="footbt">
              ...
              <tr>
            	...
            	<td id="footerlink" height="20" align="center" style="padding-top:10px;">
           		...
           		<br>【免责声明】本网站所提供的信息资源，如有侵权违规请及时告知&nbsp; 联系电话：022—63301898 &nbsp;邮箱：<a href="mailto:zggzgz123@163.com" data-ke-src="mailto:zggzgz123@163.com">zggzgz123@163.com</a>
