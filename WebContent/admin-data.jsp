		...
		<div id="section">
			...
			<div id="content">
				<div class="tab3">
					...
					<div style="margin-top:20"><input type="text" name="textfield" placeholder="请输入学校名字进行检索"  id="mytext" style="width:600;height:20;border-width:1px;border-color:black;font-size:70%"/></div>
