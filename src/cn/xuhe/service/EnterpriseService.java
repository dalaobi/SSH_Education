...
public class EnterpriseService{
	...
	public void saveAvatar(String filename,int enterpriseId){
		System.out.println("service:"+filename);
		Enterprise enter = enterpriseDAO.findById(enterpriseId);
		enter.setUrl("image/"+filename);
		enterpriseDAO.merge(enter);
	}
