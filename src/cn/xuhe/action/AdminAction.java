...
//	private Boolean isaccepted;
	...
	public String changepassword() throws Exception{
		...
		String adminid = (String)session.get("user");
		String password = adminService.getAdminDAO().findById(adminid).getPassword();
		...
		adminService.savePassword(adminid, newpassword);
		System.out.println(adminid+"------------------");
		return SUCCESS;
	}
