...
public class InformationAction extends ActionSupport{
	...
	public String update_footer() throws IOException{
		informationService.setFooterItem(footerItem, link);
		
		return "footer";
	}
	
	public String get_footer() throws IOException{
		
		result = informationService.getAllFooter();
	...
	public String update_video_interface() throws IOException{
			...
			String webName = "http://10.125.106.11:8080/SSH_Education2/information/"+getTimeStamp()+"."+getExt();
			File image = new File(url,iname);
			
			FileUtils.copyFile(file, image);			
//			informationService.saveinformation(5, "首页视频"+";"+"", "视频", iname, false);
			result = new HashMap<String,Object>();
			result.put("result", webName);
	...
	public String more(){
		ts = typeService.getType(type);            //ts 返回 int type对应的 type字段 findbyid

		lists = informationService.list_information(type);     // find by type
		return SUCCESS;
	}
