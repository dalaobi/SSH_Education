...
<div id="element" class="element">
    <div class="uploadHeader">更新应用</div>
...
<div id="section" class="clearfix">
    <div id="left">
        ...
        <div style='margin-top:30px'>
            <a href="#" id="displayCover" class="updateResume" >更新应用举例</a>
            <label style='font-size:12px;text-align:center'>请上传应用举例</label>

        </div>
        <span id="num">当前共有0份应用举例</span>
    </div>
    <div id="right">
