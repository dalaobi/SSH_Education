...
<!--标题栏idnav，class navpart  功能： type=n -->
	<div id="nav">
...
<div id="slider">
		<div id="slider1" class="slider-image">
			<img id="simg1" src="image/gaochukanyanda.jpg" />
		</div>
		<div id="slider2" class="slider-image">
			<img id="simg2" src="image/lixia.jpg" />			
		</div>
		<div id="slider3" class="slider-image">
			<img id="simg3" src="image/goodyuandan.jpg" />
		</div>
		<div id="slider4" class="slider-image">
			<img id="simg4" src="image/gaochukanyanda.jpg" />
		</div>
		<div id="slider5" class="slider-image">
			<img id="simg5" src="image/lixia.jpg" />
		</div>
		<div id="slider6" class="slider-image">
			<img id="simg6" src="image/goodyuandan.jpg" />
			<a id="sa6"></a>
		</div>
	...
	<div class="content clearfix">
		<div class="content-span200">
			<div id="content-frame-17" class="content-frame-17">
				<div class="content-frame-header light-border">
					<h1><a href="more.action?type=17">应用举例</a><a href="more.action?type=17" class="more">more</a></h1>
				</div>
			...
			<div id="content-frame-18"  class="content-frame-17">
				<div class="content-frame-header light-border">
					<h1><a href="more.action?type=18">衍生产品</a><a href="more.action?type=18" class="more">more</a></h1>
				</div>
		...
		<div class="content-span400">
			<div id="content-frame-3" class="content-frame-realnew">
				<div class="content-frame-header light-border">
					<h1><a href="more.action?type=3">智能模型</a><a href="more.action?type=3" class="more">more</a></h1>
				</div>
			...
			<div id="content-frame-6" class="content-frame-6">
				<div class="content-frame-header light-border">
					<h1><a href="more.action?type=6">工程应用</a><a href="more.action?type=6" class="more">more</a></h1>
				</div>
			...
			<div id="content-frame-4"  class="content-frame-4">
				...
				<div id="fslider">
							<div id="fslider1" class="fslider-image">
								<img id="fsimg1" src="http://n.sinaimg.cn/news/w429h210/20180122/TNkh-fyqwiqi1958734.gif" />
							</div>
							<div id="fslider2" class="fslider-image">
								<img id="fsimg2" src="http://n.sinaimg.cn/sinacn/w480h360/20180122/315d-fyqwiqi2532807.jpg" />				
							</div>
							<div id="fslider3" class="fslider-image">
								<img id="fsimg3" src="http://s.img.mix.sina.com.cn/auto/resize?img=http%3A%2F%2Fn.sinaimg.cn%2Fent%2F4_img%2Fupload%2Ffc8e0ed6%2Fw1024h1024%2F20180121%2FlWoa-fyqtwzv4310905.jpg&size=0_143" />
							</div>
							<div id="fslider4" class="fslider-image">
								<img id="fsimg4" src="http://k.sinaimg.cn/n/blog/transform/w250h150/20180117/kFjq-fyqrewi9821679.jpg/w250h150l0t0677.jpg" />
							</div>
							<div id="fslider5" class="fslider-image">
								<img id="fsimg5" src="http://s.img.mix.sina.com.cn/auto/resize?img=http%3A%2F%2Fn.sinaimg.cn%2Fent%2Ftransform%2Fw300h200%2F20180122%2FKgCB-fyqwiqi2696794.jpg&size=160_107" />
								<a id="fsa5"></a>
							</div>
