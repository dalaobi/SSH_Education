  	...
  	<div id="mceu_150" class="mce-container mce-first mce-last mce-btn-group" role="group">
		...
		<div id="section">
			...
			<div id="content">
				...
				<form id="establishform" action="infoup_upload.action" method="post" enctype="multipart/form-data" target="_top" >
					<div id="selectdiv" class="row2">
						...
						<div class="row4">			
							<p><input id="newsup" class="newsup" type="button" value="上传" onclick="admin_establish()"/></p>
